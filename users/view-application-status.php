          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="">
                    <?php
                    $vid=$_GET['viewid'];
$sql="SELECT tbluser.ID as uid,tbluser.FullName,tbluser.MobileNumber,tbluser.Email,tbluser.RegDate,tbluser.UserName,tblscheme.ID as sid,tblscheme.SchemeName,tblscheme.SchemeType,tblscheme.SchemeGrade,tblscheme.Yearofscholarship,tblscheme.Category,tblscheme.Criteria,tblscheme.DocomentRequired,tblscheme.LastDate,tblscheme.ScholarDesc,tblscheme.ScholarAmount,tblscheme.PublishedDate,tblapply.ID as appid,tblapply.ApplicationNumber,tblapply.ApplyDate,tblapply.Status,tblapply.DateofBirth,tblapply.Gender,tblapply.Category,tblapply.Religion,tblapply.Address,tblapply.AadharNumber,tblapply.ProfilePic,tblapply.DocReq,tblapply.Remark,tblapply.DisbursedAmount, tblapply.DocReq1,
            tblapply.DocReq2 from tblapply join tbluser on tblapply.UserID=tbluser.ID join tblscheme on tblapply.SchemeId=tblscheme.ID where tblapply.ID = :vid";
$query = $dbh -> prepare($sql);
 ...
 View Application Details: <?php  echo $appsno=$row->ApplicationNumber;?></td></tr>
  ...
  <tr>
   <th>Profile Pic</th>
    ...
    <td><a href="document/<?php  echo $row->DocReq;?>" target="blank" title="For View Doc Click here">Domicile Certificate</a><br>
    <a href="document/<?php  echo $row->DocReq1;?>" target="blank" title="For View Doc Click here">Caste Certificate</a><br>
    <a href="document/<?php  echo $row->DocReq2;?>" target="blank" title="For View Doc Click here">Income Certificate</a>
  </td>
  </tr>
  <tr>
    <th>Apply Date</th>
