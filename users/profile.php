...
{               ?>
           ...
           <div class="form-group">
            <label for="input-5">Date of Birth</label>
            <input type="text" class="form-control" id="regdate" name="regdate" value="<?php  echo $row->dob;?>" required="true">
           </div>
           <div class="form-group">
            <label for="input-5">Gender</label>
            <input type="text" class="form-control" id="regdate" name="regdate" value="<?php  echo $row->gender;?>" required="true">
           </div>
           <div class="form-group">
            <label for="input-3">Category</label>
            <input type="email" class="form-control" id="email" name="email" value="<?php  echo $row->category;?>" required='true'>
           </div>
           <div class="form-group">
            <label for="input-5">Adhaar No</label>
            <input type="text" class="form-control" id="regdate" name="regdate" value="<?php  echo $row->adhar;?>" required="true">
           </div>
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control" id="regdate" name="regdate" value="<?php  echo $row->address;?>" required="true">
           </div>
      ...
      <div class="col-lg-6">
         <div class="card">
           ...
           <hr>
            ...
            <div class="form-group">
            <label for="input-1">10th percentage/cgpa</label>
            <input type="text" class="form-control" id="adminname" name="adminname" value="<?php  echo $row->FullName;?>" required='true'>
           </div>
           <div class="form-group">
            <label for="input-2">12th marks/cgpa</label>
            <input type="text" class="form-control" id="username" name="username" value="<?php  echo $row->UserName;?>" readonly="true">
           </div>
           <div class="form-group">
            <label for="input-3">Graduation</label>
            <input type="email" class="form-control" id="email" name="email" value="<?php  echo $row->Email;?>" required='true'>
           </div>
