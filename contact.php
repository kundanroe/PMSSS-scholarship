...
<html lang="en">
  <head>
    <title>ASHAVRITI | Contact Us Page</title>
...
{               ?>
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span> <?php  echo htmlentities($row->PageDescription);?></p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> + <?php  echo htmlentities($row->MobileNumber);?></p>
          </div>
          <div class="col-md-3">
