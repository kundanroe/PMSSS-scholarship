...
$sql= "update tblapply set Status=:status,Remark=:remark where ID=:viewid";
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <table class="table table-bordered table-hover data-tables">
    ...
    <td>
    <textarea name="remark" placeholder="Remark" rows="8" cols="14" class="form-control wd-450" required="true" style="border:solid #000 1px; color:#000"></textarea></td>
  </tr> 
  ...
  <tr>
   ...
   <select name="status" class="form-control wd-450" required="true" style="border:solid #000 1px; background-color:#fff; color:#000;">
