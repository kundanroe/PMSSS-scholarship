...
if($_GET['del']){
$schid=$_GET['del'];
$sql= "delete from tblscheme where ID='$schid'";
$query=$dbh->prepare($sql);
$query->execute();
echo "<script>alert('Data Deleted');</script>";
echo "<script>window.location.href='manage-scheme.php'</script>";
...
{               ?>
                    <tr>
                                                ...
                                                <td><a href="edit-scheme-detail.php?editid=<?php echo htmlentities ($row->ID);?>" class="btn btn-primary btn-sm">Edit</a>
<a href="manage-scheme.php?del=<?php echo htmlentities($row->ID);?>" onclick="return confirm('Do you really want to delete?');" class="btn btn-danger btn-sm">Delete</a>
