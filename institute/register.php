	...
	<div class="card card-authentication1 mx-auto my-4">
		<div class="card-body">
		 ...
		 <a href='../index.php'>ASHAVRITI</a>
		  ...
		  <div class="card-title text-uppercase text-center py-3">Sign Up Institution</div>
		    <form method="post">
			  <div class="form-group">
			  <label for="exampleInputName" class="sr-only">Full Name</label>
			   <div class="position-relative has-icon-right">
				  <input type="text" id="fname" name="fname" class="form-control" placeholder="AISHE CODE" required="true">
			  ...
			  <label for="exampleInputName" class="sr-only">Username</label>
			   <div class="position-relative has-icon-right">
				  <input type="text" id="fname" name="username" class="form-control input-shadow" placeholder="College Name" required="true">
				  <div class="form-control-position">
					  <i class="icon-user"></i>
				  </div>
			   </div>
